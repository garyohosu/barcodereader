...
### Q17. BarcodeAnalyzer のスレッドと ViewModel への通知方法【重大度: 低】✅
...
- バーコード文字列確定後、ViewModel への通知は `viewModelScope.launch { ... }` または `withContext(Dispatchers.Main)` で Main thread に切り替える
